...
async function parse() {
  ...
  items.filter(i => i.str.includes("OPEN") || i.str.includes("Üstlenilmiş") || i.str.includes("Kimlik")).slice(0, 10).forEach(i => console.log(`Y: ${i.y.toFixed(2)} X: ${i.x.toFixed(2)} - ${i.str}`));
}
parse();
